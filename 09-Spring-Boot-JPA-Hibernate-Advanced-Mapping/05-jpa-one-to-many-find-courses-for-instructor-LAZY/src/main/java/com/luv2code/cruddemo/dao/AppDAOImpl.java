...
public class AppDAOImpl implements AppDAO {
    ...
    /**
     * Retrieves a list of courses associated with a specific instructor by their ID.
     * <p>
     * This method uses a JPQL query to fetch all Course entities where the instructor's
     * ID matches the provided parameter.
     *
     * @param id The ID of the instructor whose courses are to be retrieved.
     * @return A list of Course entities associated with the instructor.
     */
    @Override
    public List<Course> findCoursesByInstructorId(int id) {

        // Create a TypedQuery to fetch courses associated with the given instructor ID
        TypedQuery<Course> typedQuery = entityManager.createQuery(
                "FROM Course WHERE instructor.id = :p_id",
                Course.class
        );
