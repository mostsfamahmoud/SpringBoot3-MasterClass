 ...
 * related to the Instructor, InstructorDetail, Course, and Student entities.
 * <p>
...
public class AppDAOImpl implements AppDAO {
    ...
    public Course findCourseAndStudentsByCourseId(int id) {
        // Create a TypedQuery to fetch the Course and associated students using a JOIN FETCH
        TypedQuery<Course> typedQuery = entityManager.createQuery(
                "SELECT c " +
                        "FROM Course c " +
    ...
    public Student findStudentAndCoursesByStudentId(int id) {
        // Create a TypedQuery to fetch the Student and associated courses using a JOIN FETCH
        ...
        // Set the parameter for the student ID
    ...
    public void update(Student updatedStudent) {
        // Merge the student entity to update it in the database
    ...
    public void deleteStudentById(int id) {
        // Find the student entity by its ID
        Student student = entityManager.find(Student.class, id);

        // If the student exists, remove it from the database
        if (student != null) {
