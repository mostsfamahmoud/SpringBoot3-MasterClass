...
public class CruddemoApplication {
    ...
    private void deleteStudent(AppDAO appDAO) {
        ...
        int id = 1;
        System.out.println("Initiating deletion of student with ID: " + id);

        // Perform deletion of the student entity
    ...
    /**
     * Adds more courses for a specific student.
     *
     * @param appDAO DAO object for database operations.
     */
    private void addMoreCoursesForStudent(AppDAO appDAO) {
        // Specify the ID of the student to update
        int studentId = 2;

        // Fetch the student and their courses using a custom DAO method
    ...
    /**
     * Retrieves a student along with their enrolled courses.
     *
     * @param appDAO DAO object for database operations.
     */
    private void getStudentWithCourses(AppDAO appDAO) {
        // Specify the ID of the student to retrieve
        int studentId = 2;
        ...
        // Display the list of associated courses
        System.out.println("Associated Courses: " + student.getCourses());
    ...
    /**
     * Retrieves a course along with its enrolled students.
     *
     * @param appDAO DAO object for database operations.
     */
    private void getCourseWithStudents(AppDAO appDAO) {
        ...
        // Fetch the course and its students using a custom DAO method
    ...
    /**
     * Creates a new course and enrolls students in it.
     *
     * @param appDAO DAO object for database operations.
     */
    private void createCourseAndStudents(AppDAO appDAO) {
        ...
        Student student2 = new Student("Mostafa", "Nasser", "mostafa@luv2code.com");
    ...
    private void deleteCourse(AppDAO appDAO) {
        int id = 14; // ID of the course to delete
