...
public class AopdemoApplication {
    ...
    private void demoTheAroundAdviceRethrowException(TrafficFortuneService fortuneService) {
        ...
        try {
            ...
            // Handling the exception that is thrown by the @Around Advice
            data = fortuneService.getFortune(activateExp);

        } catch (Exception exception) {
            System.out.println("\nMain Program: The Rethrown Exception ( " + exception + " ) is handled");
        }
    ...
    private void demoTheAroundAdviceHandleException(TrafficFortuneService fortuneService) {
        ...
        // Handling the exception is done on the @Around Advice (Not here)
        String data = fortuneService.getFortune(activateExp);
