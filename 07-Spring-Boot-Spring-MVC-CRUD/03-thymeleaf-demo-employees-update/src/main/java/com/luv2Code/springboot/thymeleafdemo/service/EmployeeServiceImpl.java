 ...
 * <p>
 * Provides business logic for managing employees by delegating data access operations
 * to the repository layer. The @Service annotation marks this class as a Spring-managed service component.
 */
@Service
public class EmployeeServiceImpl implements EmployeeService {
    ...
    /**
     * Retrieves a list of all employees ordered by last name in ascending order.
     * <p>
     ...
     * <p>
     * Fetches a specific employee from the repository layer based on their ID.
